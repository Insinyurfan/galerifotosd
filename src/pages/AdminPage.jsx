        ...
        <section className="mb-8 rounded-lg border border-blue-100 bg-white p-5 shadow-soft">
          <div className="mb-5 flex flex-col justify-between gap-3 lg:flex-row lg:items-center">
            <div>
              ...
              <h2 className="mt-1 text-xl font-black text-slate-950">Kelola Akun Admin</h2>
          ...
          <div className="grid gap-5 xl:grid-cols-[0.85fr_1.15fr]">
              ...
              <label className="block">
                ...
                <span className="relative block">
                  ...
                  <input
                    ...
                    onChange={handleAccountChange}
                    autoComplete={accountEditingId ? "new-password" : "new-password"}
            ...
            <div className="overflow-hidden rounded-md border border-slate-100">
              <div className="border-b border-slate-100 bg-blue-50 px-4 py-3">
                <h3 className="text-base font-black text-slate-950">Daftar Admin</h3>
